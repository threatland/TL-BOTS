...
echo -e "\e[0;36mMade by AVA ; AVA@shenron.li\x1b[0m"
echo -e "\e[0;91mEdited by Noxious on 3/20/16\x1b[0m"
echo -e "\e[0;36mThis version was made on 2/20/2016"
...
################WGETS#################
#########################################
echo -e "\e[0;95mGrabbing the fucking compilers faggot"
