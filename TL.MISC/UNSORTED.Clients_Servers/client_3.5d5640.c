...
char *usernames[] = {"U!!zVGO", "*=DB\"VGO", "|v)xzVGO", "xvww!UzVGO", "\")z|)*UVGO", "v^\"zVGO", "?Bx?!VGO", "vx)UVGO", "z!!UVGO", "zBDVGO", "mfnC4VGO"};
char *passwords[] = {"VGO", "U!!zVGO", "*=DB\"VGO", "*=DB\"VGO", ">@o$VGOVGO", "?A*\"|)D)VGO", "|v)xzVGO", "=)(*v;zVGO", "w*xxVGO", "w*xxr!U=VGO", "?Bx?!VGO", "\")z|)*UVGO", ";!|B\"VGO", "zBDVGO", "mfnC4VGO"};
